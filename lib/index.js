...
logger_1._logger.info('Version: v2');
console.log('Version: v2');
var scraper = new browser_utils_1.ImageScraper();
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var sbClient, queueClient, receiver, repository, conn, messages, extractResponses, completeBookIds, query, failedBookIds, query, msgCompleteReq, res, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    logger_1._logger.info('batch start');
                ...
                case 5:
                    ...
                    query = "UPDATE [dbo].[BookInformation] SET IsImageDownloaded = 'True', ImageDownloadState = 4 WHERE Id IN(" + completeBookIds.map(function (bookId) { return "\'" + bookId + "\'"; }).join(",") + ")";
                ...
                case 7:
                    ...
                    if (!(failedBookIds.length > 0)) return [3 /*break*/, 9];
                    query = "UPDATE [dbo].[BookInformation] SET ImageDownloadState = 3 WHERE Id IN(" + failedBookIds.map(function (bookId) { return "\'" + bookId + "\'"; }).join(",") + ")";
                    return [4 /*yield*/, conn.request().query(query)];
                case 8:
                    _a.sent();
                    logger_1._logger.error("image extraction failed for book ids " + failedBookIds.join());
                    _a.label = 9;
                case 9:
                    msgCompleteReq = messages.map(function (msg) { return msg.complete(); });
                    return [4 /*yield*/, Promise.all(__spread(msgCompleteReq))];
                case 10:
                    res = _a.sent();
                    logger_1._logger.info('batch end total messages ', messages.length);
                    console.log(new Date() + " batch end total messages ", messages.length);
                    return [3 /*break*/, 3];
                case 11: return [3 /*break*/, 15];
                case 12:
                    err_1 = _a.sent();
                    logger_1._logger.error('error on while read', err_1);
                    process.exit(1);
                    return [3 /*break*/, 15];
                case 13: return [4 /*yield*/, sbClient.close()];
                case 14:
                    _a.sent();
                    return [7 /*endfinally*/];
                case 15:
...
var msgHandler = function (message) { return __awaiter(void 0, void 0, void 0, function () {
    var book, response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
