        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    logger_1.logger.info('batch start');
                ...
                case 7:
                    ...
                    if (failedBookIds.length > 0) {
                        logger_1.logger.error("image extraction failed for book ids " + failedBookIds.join());
                    }
                    msgCompleteReq = messages.map(function (msg) { return msg.complete(); });
                    return [4 /*yield*/, Promise.all(__spreadArrays(msgCompleteReq))];
                case 8:
                    res = _a.sent();
                    logger_1.logger.info('batch end total messages ', messages.length);
                    return [3 /*break*/, 3];
                case 9: return [3 /*break*/, 13];
                case 10:
                    err_1 = _a.sent();
                    logger_1.logger.error('error on while read', err_1);
                    return [3 /*break*/, 13];
