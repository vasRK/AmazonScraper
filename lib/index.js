...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var sbClient, queueClient, receiver, repository, conn, messages, extractResponses, completeBookIds, query, failedBookIds, msgCompleteReq, res, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    ...
                    query = "UPDATE [dbo].[BookInformation] SET IsImageDownloaded = 'True' WHERE Id IN(" + completeBookIds.map(function (msgId) { return "\'" + msgId + "\'"; }).join(",") + ")";
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                logger_1._logger.info('fetch start: ', book.isbn13);
