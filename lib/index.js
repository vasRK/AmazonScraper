...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var sbClient, queueClient, receiver, browserUtils, currentBatchMsgs, repository, msgHandler, onErrorHandler, conn, fetchInProgress, messages, ids, query, updateReq, msgCompleteReq, response, err_1;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    browserUtils = new browser_utils_1.BrowserUtils();
                    currentBatchMsgs = new Array();
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, browserUtils.getBookImages(book.isbn13, book.bookId)];
                                case 1:
                                    _a.sent();
                                    console.log('image extracted', book.isbn13);
                                    currentBatchMsgs = currentBatchMsgs.filter(function (msg) { return msg.messageId != message.messageId; });
                ...
                case 4:
                    messages = _a.sent();
                    currentBatchMsgs.push.apply(currentBatchMsgs, messages);
                    return [4 /*yield*/, Promise.all(messages.map(msgHandler))];
                case 5:
                    _a.sent();
                    ids = messages.map(function (msg) { return "\'" + msg.messageId + "\'"; }).join(",");
                    query = "UPDATE [dbo].[BookInformation] SET IsImageDownloaded = 'True' WHERE Id IN(" + ids + ")";
                    console.log('query', query);
                    updateReq = conn.request().query(query);
                    msgCompleteReq = messages.map(function (msg) { return msg.complete(); });
                    response = Promise.all(__spreadArrays(msgCompleteReq, [updateReq]));
                ...
                case 7:
                    ...
                    return [3 /*break*/, 10];
                case 8: return [4 /*yield*/, sbClient.close()];
                case 9:
                    _a.sent();
                    return [7 /*endfinally*/];
