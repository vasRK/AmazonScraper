...
var BlobClientUtil = /** @class */ (function () {
    ...
    BlobClientUtil.GetClient = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, blobServiceClient.getContainerClient("banana-prod")];
                    case 1:
    ...
    BlobClientUtil.UploadBlob = function (fileName, buffer) {
        return __awaiter(this, void 0, void 0, function () {
            var containerClient, blockBlobClient;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, BlobClientUtil.GetClient()];
                    case 1:
                        containerClient = _a.sent();
